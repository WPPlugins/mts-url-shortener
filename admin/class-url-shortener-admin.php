...
class MTS_URL_Shortener_Admin {
	...
	public function __construct( $plugin_name, $version ) {
        ...
        $this->screen_base = sanitize_title( __('Short Links', 'mts-url-shortener') );
        $this->screens = array( 
    ...
    function url_shortener_admin_notice_ignore() {
        global $current_user;
            ...
            if ( isset($_GET['url_shortener_admin_notice_ignore']) && '0' == $_GET['url_shortener_admin_notice_ignore'] ) {
                 add_user_meta($user_id, 'url_shortener_ignore_notice', 'true', true);
        }
    }
